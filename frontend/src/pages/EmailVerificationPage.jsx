      ...
      >
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <motion.button
						...
						className='w-full  font-medium text-black bg-white font-bold py-3 px-4 rounded-lg shadow-lg  focus:outline-none focus:ring-2   disabled:opacity-50'
					>
