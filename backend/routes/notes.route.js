...
import { createNote,getAllNotes, updateNote, getNotesByCrypto,deleteNote,associateNoteWithCrypto,getNoteById,dissociateNoteFromCrypto,dissociateAllNotesFromCrypto } from '../controllers/notes.controller.js'
...
router.post("/dissociateNote", verifyToken, dissociateNoteFromCrypto);
router.post("/dissociateAllNotes", verifyToken, dissociateAllNotesFromCrypto);
